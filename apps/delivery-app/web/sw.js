// Driver service worker — the phone opens with no signal (§31), which on a delivery round is most
// of the round.
//
// It caches the shell and the last page the box actually served. **Yesterday's route must never be
// served as today's**, so the page is fetched fresh whenever there is a signal and a cached one
// announces itself. Proof of delivery and cash collected live in the device's own outbox, not here.
//
...
const CACHE = 'sre-driver-shell-v2';
...
const BUILT = ['./delivery-app.bundle.js'];
