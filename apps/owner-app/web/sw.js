// Owner app service worker — makes the brief open with no signal (§31), so the owner can look at
// the shop from anywhere.
//
// It caches the shell and the last page the phone was actually served. The brief's figures are
// whatever the phone last received and are **never presented as live when they are not**: the app's
// own freshness indicator leads when they are stale, and a page served from this cache says so as
// well.
//
...
const BUILT = ['./owner-app.bundle.js'];
