...
export const ERP_NAVIGATION: readonly NavItem[] = Object.freeze([
  ...
  { id: 'day-reopen', label: 'Reopen a locked day', path: '/day-reopen', requires: 'till.dayclose.read', group: 'Administration' },
  ...
  { id: 'data-io', label: 'Import & export', path: '/data-io', requires: 'export.read', group: 'Administration' },
