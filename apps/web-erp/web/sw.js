...
//
// **This folder serves eleven screens** — the manager's, the buyer's, prices, shelves and space,
// reports, customer service, expiry and recall, finance, admin and security, AI control, and
...
const CACHE = 'sre-erp-shell-v8';

/** Committed files. A missing one is a packaging fault and should fail the install loudly. */
const SHELL = ['./app.js', './buying.js', './catalogue.js', './merchandising.js', './reporting.js', './service.js', './expiry.js', './finance.js', './admin.js', './ai.js', './migration.js', './manifest.webmanifest'];
