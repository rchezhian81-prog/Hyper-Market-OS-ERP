...
//
// **This folder serves ten screens** — the manager's, the buyer's, prices, shelves and space, reports,
// customer service, expiry and recall, finance, admin and security, and AI control —
...
const CACHE = 'sre-erp-shell-v7';

/** Committed files. A missing one is a packaging fault and should fail the install loudly. */
const SHELL = ['./app.js', './buying.js', './catalogue.js', './merchandising.js', './reporting.js', './service.js', './expiry.js', './finance.js', './admin.js', './ai.js', './manifest.webmanifest'];
