...
//
// **This folder serves seventeen screens** — the manager's, the buyer's, prices, shelves and space,
// reports, customer service, expiry and recall, finance, GST reconciliation, category rules, GST returns,
// waste and write-off, stock counts, devices, admin and security, AI control, and moving off the old system —
...
const CACHE = 'sre-erp-shell-v25';

/** Committed files. A missing one is a packaging fault and should fail the install loudly. */
const SHELL = ['./app.js', './buying.js', './catalogue.js', './merchandising.js', './reporting.js', './service.js', './expiry.js', './finance.js', './gst-reconciliation.js', './category-policy.js', './gst-returns.js', './waste.js', './counts.js', './fleet.js', './product-publish-review.js', './data-quality.js', './operations.js', './loss-prevention.js', './cash-office.js', './risk-acceptance.js', './day-reopen.js', './stock-health.js', './data-io.js', './workforce.js', './ess.js', './admin.js', './ai.js', './migration.js', './manifest.webmanifest'];
