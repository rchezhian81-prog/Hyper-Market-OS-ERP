...
**Last updated:** 8 August 2026 (**OA-10 added** — a low-risk, non-blocking request for a native-Tamil
review of the Warehouse handheld's on-screen wording; the words are present, complete and guarded, and
the English is authoritative, so this is a quality check before go-live, not a blocker. Earlier:
