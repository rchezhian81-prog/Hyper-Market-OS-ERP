...
M32–M35.
- **Done:** M01, M02, M03, M04, M05, M06, M07.
- **Next:** M08–M11 (inventory/warehouse/quality), then M12–M15 (POS/cash),
  then M23, M29, M30, M32–M35.
...
1. **Continue Stage 2 with M08** (inventory ledger), then M09–M11, M12–M15, and
