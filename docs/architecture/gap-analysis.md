...
| `apps/` — everything a person touches | 10,800 | **All six have real screens, and the ERP now has ten** — the manager's, the buyer's, the product and price screen, merchandising and space, reporting, the service desk, expiry and recall, finance, admin and security, and AI control. The gap that dominated this document is closed |
| Tests | 4,334 + 31 | Unusually thorough on rules; thin on assembly until today |
