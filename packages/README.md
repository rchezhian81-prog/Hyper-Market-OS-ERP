...
| `catalogue` | Lane catalogue & barcode scan | O(1) offline lookup from a versioned snapshot; weight/price-embedded barcodes; recalled/non-sellable refused at the scan (M03, M12, §31, §32) |
