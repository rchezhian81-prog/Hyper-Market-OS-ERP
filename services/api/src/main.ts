...
export function buildSurface(deps: {
  ...
  return [
    ...
    ...segmentRoutes(store === undefined
      ? { now, policy: empty(undefined), recordPolicy: () => {} }
      : { now, ...segmentPolicyAdapter({ store, now }) }),
