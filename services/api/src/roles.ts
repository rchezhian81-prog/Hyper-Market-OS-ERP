...
export const ROLE_CATALOGUE: readonly Role[] = [
  {
    ...
    permissions: [
      ...
      'service.case.manage', 'service.case.read',
      ...
      'shelf.count.record', 'shelf.count.read', 'planogram.compliance.read',
  ...
  },
  {
    ...
    permissions: [
      ...
      'scrap.review.read', 'waste.view', 'count.view', 'shelf.count.record', 'shelf.count.read', 'planogram.compliance.read', 'workforce.roster.read', 'workforce.task.read', 'workforce.checklist.read', 'workforce.incentive.read', 'workforce.sop.read',
