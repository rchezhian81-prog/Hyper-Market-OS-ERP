...
export const ROLE_CATALOGUE: readonly Role[] = [
  {
    ...
    permissions: [
      ...
      'shelf.count.record', 'shelf.count.read', 'planogram.compliance.read', 'merchandising.space.read', 'merchandising.display.manage',
  ...
  },
  {
    ...
    permissions: [
      ...
      'scrap.review.read', 'waste.view', 'count.view', 'shelf.count.record', 'shelf.count.read', 'planogram.compliance.read', 'merchandising.space.read', 'merchandising.display.manage', 'workforce.roster.read', 'workforce.task.read', 'workforce.checklist.read', 'workforce.incentive.read', 'workforce.sop.read',
