...
export const ROLE_CATALOGUE: readonly Role[] = [
  {
    ...
    permissions: [
      ...
      'purchase.order.propose', 'purchase.order.approve', 'purchase.supplier.block',
  ...
  },
  {
    ...
    permissions: [
      ...
      'purchase.order.propose', 'purchase.supplier.block',
      'supplier.portal.manage', 'supplier.portal.submit', 'supplier.portal.review',
      'inventory.movement.append', 'inventory.availability.read',
      'production.recipe.manage', 'production.plan.commit', 'production.release', 'production.read',
      'pos.sale.sync', 'pos.sale.read', 'pos.exception.read', 'pos.return.record', 'pos.restricted.check',
      ...
      'scrap.review.read', 'waste.view', 'count.view', 'workforce.roster.read', 'workforce.task.read', 'workforce.checklist.read', 'workforce.incentive.read', 'workforce.sop.read',
