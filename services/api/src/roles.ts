...
export const ROLE_CATALOGUE: readonly Role[] = [
  {
    ...
    permissions: [
      ...
      'shelf.count.record', 'shelf.count.read',
  ...
  },
  {
    ...
    permissions: [
      ...
      'scrap.review.read', 'waste.view', 'count.view', 'shelf.count.record', 'shelf.count.read', 'workforce.roster.read', 'workforce.task.read', 'workforce.checklist.read', 'workforce.incentive.read', 'workforce.sop.read',
