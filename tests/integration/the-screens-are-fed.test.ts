...
describe('a box that has been told nothing tells every screen so', () => {
  const nothing = snapshotOf({
    pack: {
      ...
      dataQualityPolicy: notKnown('never'), operationsInboxPolicy: notKnown('never'), lossPreventionPolicy: notKnown('never'), cashOfficePolicy: notKnown('never'), dataIoPolicy: notKnown('never'), workforceInboxPolicy: notKnown('never'), essPolicy: notKnown('never'),
