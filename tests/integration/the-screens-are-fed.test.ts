...
describe('a box that has been told nothing tells every screen so', () => {
  const nothing = snapshotOf({
    pack: {
      ...
      dataQualityPolicy: notKnown('never'), operationsInboxPolicy: notKnown('never'), lossPreventionPolicy: notKnown('never'), returnGovernancePolicy: notKnown('never'), cashOfficePolicy: notKnown('never'), riskAcceptancePolicy: notKnown('never'), dayReopenPolicy: notKnown('never'), stockHealthPolicy: notKnown('never'), storedValuePolicy: notKnown('never'), integrationHealthPolicy: notKnown('never'), goodsReceiptPolicy: notKnown('never'), dataIoPolicy: notKnown('never'), workforceInboxPolicy: notKnown('never'), essPolicy: notKnown('never'), rosteringPolicy: notKnown('never'), checklistPolicy: notKnown('never'), productionPolicy: notKnown('never'), facilitiesPolicy: notKnown('never'),
